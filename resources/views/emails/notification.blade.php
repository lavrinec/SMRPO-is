    ...
    <tr>
        ...
        <td class="container">
            <div class="content">
                ...
                <span class="preheader">Obvestilo o nalogah, ki se jim bliža rok.</span>
                <table class="main">
                                    ...
                                    <td>
                                        ...
                                        <ul>
                                            @foreach($items as $item)
                                                <li>
                                                    {{ $item->card_name }}
                                                    , rok: {{ date("d.m.Y", strtotime($item->deadline)) }}
                                                    @if(isset($item->user))
                                                        , nosilec: {{ $item->user->first_name }} {{ $item->user->last_name }}
                                                    @endif
                                                </li>
                                            @endforeach
                                        </ul>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                ...
                                <br> Ne želite več prejemati obvestil? <a href="#">Odjava</a>.
                            </td>
                        </tr>
                    </table>
                </div>
