      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/pages/charts/inline"><i class="fa fa-circle-o"></i> Inline charts</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
...
<!-- SlimScroll -->
<script src="/dependenciesjquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
...
<!-- jQuery Knob -->
<script src="/dependencies/jquery-knob/js/jquery.knob.js"></script>
<!-- Sparkline -->
