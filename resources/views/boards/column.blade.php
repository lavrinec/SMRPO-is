                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="{{ $column_id }}_column_name"
                               name="{{ $column_id }}_column_name" placeholder="Ime" pattern=".{1,255}" required
        ...
        <div class="box-body" style="border-top: solid black 1px;">
            <div class="content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="{{ $column_id }}_description"
                               name="{{ $column_id }}_description" placeholder="Opis" pattern=".{1,255}" required
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" class="form-control" id="{{ $column_id }}_wip" name="{{ $column_id }}_wip"
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <label for="{{ $column_id }}_acceptance_testing" class="control-sidebar-subheading">
                            <input id="{{ $column_id }}_acceptance_testing" name="{{ $column_id }}_types[]"
